  ...
  return (
    <main className="staticPage">
      <section className="staticPage__card">
        ...
        <h1>運営について</h1>
        <p>
          Doujin Infoは、DLsite女性向け同人作品の公開情報を整理し、ユーザーが自分の好みに合う作品を見つけやすくするための情報サイトです。
        </p>
        <p>
          本サイトはDLsite公式サイトではありません。掲載情報は取得時点の参考情報であり、価格、販売数、評価、割引、販売状況などの正確性・最新性を保証するものではありません。
        </p>
        <p className="staticPage__updatedAt">最終更新日：2026年7月26日</p>
        ...
        <div className="staticPage__grid">
          ...
          <div>
            <h2>データ更新方針</h2>
            <p>
              データは一定間隔で取得しており、リアルタイムではありません。人気作品と作品形式別の上位作品を中心に継続取得するため、全作品の継続データを保証するものではありません。
            </p>
          </div>
          <div>
            <h2>アフィリエイトについて</h2>
